...
-keep public class com.android.baihuahu.ota.model.OtaService
...
-keep class com.android.baihuahu.push.model.** { *; }
...
-dontwarn org.joda.time.**
 ...
 #------------------实体类 # -------------------------------------------
 -keep class com.android.baihuahu.bean.** { *; }
 -keep class com.android.baihuahu.game.bean.** { *; }
 -keep class com.android.baihuahu.App { *; }
 -keep class com.jzt.hol.android.jkda.sdk.bean.** { *; }
 -keep class com.jzt.hol.android.jkda.sdk.services.** { *; }
 -keep class com.android.baihuahu.push.model.ExtraDataBean
 -keep class com.android.baihuahu.push.model.MessageDetail
 -keep class com.android.baihuahu.activity.main.MainHomeActivity
 -keep class com.android.baihuahu.activity.hub.HubItemActivity
