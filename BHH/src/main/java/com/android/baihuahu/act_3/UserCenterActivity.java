...
import com.android.baihuahu.core.utils.FileUtil;
...
public class UserCenterActivity extends BaseFgActivity {
    ...
    /*    //修改头像
        ...
        for (int i = 1; i < 21; i++) {
            if (i < 10) {
                mUrlList.add(UrlConstant.accounts_current + "0" + i + ".png");
            } else {
                mUrlList.add(UrlConstant.accounts_current + i + ".png");
            }
        }
    ...
    private void setLayoutData() {
        ...
        addItem("岗位职级", info.employeeLevel);
        addItem("员工类型", "");
        addItem("员工状态", "");
