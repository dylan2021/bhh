...
public class Constant {
    ...
    public static final String WEB_FILE_SEE_OFFICIAL = "http://file.escrm.waylinkage.com/";

    public static final String WEB_SITE_TEST = "http://api.bhh.waylinkage.com";//测试
    public static final String WEB_FILE_SEE_TEST = "http://file.escrm.waylinkage.com/";//不行就加/file
