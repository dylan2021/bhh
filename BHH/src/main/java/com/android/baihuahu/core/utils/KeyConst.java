...
public class KeyConst {
    ...
    public static final String wageYear = "wageYear";
    ...
    public static final String businessTripId = "businessTripId";
    public static final String totalAmount = "totalAmount";

    public static final String billDetailId = "billDetailId";
    public static final String error = "error";
    public static final String realInDate = "realInDate";

    public static final String deliverDate = "deliverDate";
    public static final String supervisionCorporation = "supervisionCorporation";
    ...
    public static final String loadLevel = "loadLevel";
    ...
    public static final String emergyPhone = "emergyPhone";
    ...
    public static final String tempWorkerIdList = "tempWorkerIdList";
