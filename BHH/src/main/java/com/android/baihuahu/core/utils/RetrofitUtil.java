...
public class RetrofitUtil {
    ...
    public static void upLoadByCommonPost(String host, File file, Map<String, String> params, FileUploadListener listener) throws IOException {
        ...
        try {
            ...
            conn.setRequestProperty("Authorization", KeyConst.Bearer + App.token);
            ...
            if(file!=null) {
                ...
                //sb.append("fileType: application/octet-stream; charset="+CHARSET+LINE_END);
                sb.append(LINE_END);
                //写入文件数据
