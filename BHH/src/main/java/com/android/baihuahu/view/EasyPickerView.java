...
package com.android.baihuahu.view;
...
public class EasyPickerView extends View {
    ...
    public EasyPickerView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        textSize = a.getDimensionPixelSize(R.styleable.EasyPickerView_epvTextSize,
                (int) TypedValue.applyDimension(
                        TypedValue.COMPLEX_UNIT_SP, 16, getResources().getDisplayMetrics()));
        textColor = a.getColor(R.styleable.EasyPickerView_epvTextColor, getResources().getColor(R.color.color212121));
        textPadding = a.getDimensionPixelSize(R.styleable.EasyPickerView_epvTextPadding, (int) TypedValue.applyDimension(
                TypedValue.COMPLEX_UNIT_DIP, 20, getResources().getDisplayMetrics()));
        textMaxScale = a.getFloat(R.styleable.EasyPickerView_epvTextMaxScale, 1.2f);
        ...
        maxShowNum = a.getInteger(R.styleable.EasyPickerView_epvMaxShowNum, 5);
        a.recycle();
